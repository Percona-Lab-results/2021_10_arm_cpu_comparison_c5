...
locals {
  cpu_x86 = setproduct(["c5.large", "c5.xlarge", "c5.2xlarge", "c5.4xlarge", "c5.12xlarge","c5a.large","c5a.xlarge","c5a.2xlarge","c5a.4xlarge","c5a.12xlarge", "c5a.16xlarge"], ["gp2"])
  # cpu_x86 = setproduct(["c5.large", "c5a.large"], ["gp2"])
}
